...
3. 最好能够阅读英文，HASS是国外开发的软件平台，完全汉化不现实。
4. 多摸网关不建议使用，BLE和Zigbee会有干扰，带来稳定性问题。
5. 专用网关（如小米，涂鸦，SONOFF等）慎用。因为你需要完全依赖HACS中的集成来驱动，你所需要的功能不一定可以满足，而且价格也不便宜。
6. 语音控制，HomePod + Apple Music和HASS是最佳的组合，其它国内音箱的驱动都无法与之相比。
7. 没有BLE Mesh的使用经验。

...
还有一点说明，我不分享UI的设计，如果有需要的伙伴，可以在网上搜索，有不少的大佬有很不错的分享，如：Frankiesmall, koryking等。
   ...
   16. [C-Bus接入](https://github.com/lifeexplore/Homeassistant-Project/blob/Homeassistant-Project/CBUS.md)：灯光

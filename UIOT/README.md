...
* UIOT宣称基于Zigbee，其实它的设备只是传输层用的Zigbee（所谓的透传），协议层完全不兼容，完全无法用ZHA或者Z2M链接，Z2T虽然可以链接，但也完全不能交换数据
* 针对不同的设备，我采取了不同的方案接入，效果很好，运行很稳定
...
* 传感器：Zigbee设备。
	1. [ZHA的连接效果](https://github.com/lifeexplore/Homeassistant-Project/blob/Homeassistant-Project/UIOT/ZHA.jpg)（Z2M类似）
	...
	4. 分析结果：
	   ...
	   c. 第一个数据需要回答"FF238BFFFFFFFFA4"，如果回答不正确，第二个数据网关只能收到不完整的"FF238000158D00041EA4EE0000213104190317B"

	   d. 第二个数据需要回复"FF238000158D00041EA4EE000021310419031411B7D7"

	5. 方案实现：经过反复试验，分析，终于成功！！
